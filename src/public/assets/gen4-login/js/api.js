...
(function () {
	...
	function nt(e, r) {
		return (
			...
			Object.getOwnPropertyDescriptors
				...
				: Sr(Object(r)).forEach(function (n) {
	...
	function Ue(e, r) {
		var n = {
			...
			g;
		return (
			(g = { next: h(0), throw: h(1), return: h(2) }),
	...
	function Tt(e, r, n, o, c, l, g) {
		...
		return ""
			.concat(h, "/cdn-cgi/challenge-platform/")
			.concat(u, "turnstile/if/ov2/av0/rcv")
			.concat(o, "/")
			.concat(e, "/")
			.concat(r, "/")
			.concat(n.theme, "/")
	...
	var St = function (e, r, n) {
			var o = wt(r.params, !1),
				...
				g,
				h = ""
					.concat(o, "/cdn-cgi/challenge-platform/")
					.concat(c, "feedback-reports/")
					.concat(ze(e), "/")
					.concat(r.displayLanguage, "/")
					.concat(
						(l = r.params.theme) !== null && l !== void 0 ? l : r.theme,
						"/"
					)
					.concat(n);
		...
		if (typeof e != "string")
			throw new Error(
				"djb2: expected string, got ".concat(
					typeof e == "undefined" ? "undefined" : D(e)
				)
			);
			...
			for (
				...
				(u.watchcat.seq = e.watchCatSeq),
					u.watchcat.lastAckedSeq === 0 &&
						(u.watchcat.lastAckedSeq = e.watchCatSeq);
				var E = K(h);
				if (!E || !u.shadow) {
					u.watchcat.missingWidgetWarning ||
						(b(
				...
				if (!(u.isComplete || u.isFailed)) {
					...
					if (
						((u.isExecuting ||
							!u.isInitialized ||
							(u.isInitialized && !u.isStale && !u.isExecuted)) &&
							u.watchcat.lastAckedSeq !== 0 &&
							N) ||
						R
					) {
					...
					(f = O.contentWindow) === null ||
						f === void 0 ||
						f.postMessage(
							{ source: P, widgetId: h, seq: e.watchCatSeq, event: "meow" },
							"*"
						);
				}
			}
		...
		if (!(r === void 0 || r.hasResponseParamEl)) {
			...
			if (o) {
				...
				if (
					...
					Tr((g = r.params.sitekey) !== null && g !== void 0 ? g : "")
				) {
	...
	var Ft = (function () {
		var e = function (a, i, t, d) {
			...
			o = function (a) {
				if (!a) return [];
				for (
					var i = a.attributes, t = i.length, d = new Array(t), s = 0;
					s < t;
					s++
				)
					d[s] = i[s].name;
			...
			g = function (a) {
				...
				try {
					for (
						var s = y.widgetMap[Symbol.iterator](), v;
						!(i = (v = s.next()).done);
						i = !0
					) {
						var x = Ae(v.value, 2),
			...
			h = function (a, i, t) {
				for (; a.msgQueue.length; ) {
					...
					(d = t.contentWindow) === null ||
						d === void 0 ||
						d.postMessage({ source: P, widgetId: i, event: s }, "*");
				}
			},
			u = function (a, i) {
				if (i) {
			...
			E = function (a) {
				...
				v == null ||
					v.shadow.querySelectorAll(s.join(", ")).forEach(function (w) {
						return w.remove();
					}),
			...
			O = function (a, i) {
				...
				if (U) {
					...
					var re;
					p.execution =
						(re = p.execution) !== null && re !== void 0 ? re : pe.RENDER;
					var ye;
					p.appearance =
						(ye = p.appearance) !== null && ye !== void 0 ? ye : X.ALWAYS;
					var ne;
					p["retry-interval"] = Number(
						(ne = p["retry-interval"]) !== null && ne !== void 0 ? ne : rr
					);
					var he;
					p["expiry-interval"] = Number(
						(he = p["expiry-interval"]) !== null && he !== void 0
							? he
							: ($t - Jt) * 1e3
					);
					var ue;
					...
					typeof B != "string" &&
						m(
							'Invalid or missing type for parameter "sitekey", expected "string", got "'.concat(
								typeof B == "undefined" ? "undefined" : D(B),
								'"'
							),
							3588
						),
					...
					var we,
						Q =
							(we = p["refresh-expired"]) !== null && we !== void 0
								? we
								: $.AUTO;
					pt(Q)
						? (p["refresh-expired"] = Q)
						: m(
								'Invalid type for parameter "refresh-expired", expected never|manual|auto, got "'
									.concat(Q, '" ')
									.concat(typeof Q == "undefined" ? "undefined" : D(Q)),
								3603
						  );
					var Te,
						ae =
							(Te = p["refresh-timeout"]) !== null && Te !== void 0
								? Te
								: ie.AUTO;
					vt(Q)
						? (p["refresh-timeout"] = ae)
						: m(
								'Invalid type for parameter "refresh-timeout", expected never|manual|auto, got "'
									.concat(ae, '" ')
									.concat(typeof ae == "undefined" ? "undefined" : D(ae)),
								3603
						  );
					...
					if (!(!Re || !de)) {
						...
						var tt,
							Ar =
								(tt = p["response-field"]) !== null && tt !== void 0 ? tt : !0;
						if (Ar) {
							...
							if (
								((Ne.name =
									(rt = p["response-field-name"]) !== null && rt !== void 0
										? rt
										: bt),
			...
			T = function () {
				...
				try {
					for (
						var v = y.widgetMap[Symbol.iterator](), x;
						!(t = (x = v.next()).done);
						t = !0
					) {
						var w = Ae(x.value, 2),
		...
		function N() {
			return (
				(N = Bt(function (_, a, i, t) {
					var d, s, v, x, w, A, S, F, H, Z;
					return Ue(this, function (U) {
						switch (U.label) {
							case 0:
								if (((d = _.params.sitekey), (s = Er()), !s))
									return (
										b(
								...
								(v = "h/".concat("b", "/")),
									...
									(S = ""
										.concat(w, "://")
										.concat(x.host, "/cdn-cgi/challenge-platform/")
										.concat(v, "rc/")
										.concat(t)
										.concat(A)),
									(U.label = 1);
							...
							case 3:
								return [4, F.json()];
							case 4:
								if (((H = U.sent()), "status" in H && H.status === "redeemed"))
									return n(_, a, !0), [2];
								U.label = 5;
							case 5:
								return [3, 7];
					...
					if (!(!i || !t))
						switch (a.event) {
							...
							case "fail": {
								...
								if (H) {
									var Z,
										U = t.shadow.querySelector("#".concat(i));
									U == null ||
										(Z = U.contentWindow) === null ||
										Z === void 0 ||
										Z.postMessage(
		...
		return nt(Fe({}, I), {
					...
					typeof a != "function" &&
						m(
							'turnstile.ready() expected a "function" argument, got "'.concat(
								typeof a == "undefined" ? "undefined" : D(a),
								'"'
							),
							3841
						),
			...
			execute: function (a, i) {
				...
				if (s) {
					...
					if (
						...
						return;
					if (
						(s.isInitialized && h(s, t, w),
						s.isInitialized && s.params.appearance === X.EXECUTE && kt(w, s),
						s.isExecuting)
					) {
						var A,
							S = s.shadow.querySelector("#".concat(v));
			...
			getResponse: function (a) {
				...
				return (
					...
					(i = y.widgetMap.get(v)) === null || i === void 0
						? void 0
						: i.response
				);
			},
	...
	(ve = !1),
		(C = fr()),
		(y.scriptWasLoadedAsync =
			(Ge = C == null ? void 0 : C.loadedAsync) !== null && Ge !== void 0
				? Ge
				: !1),
		(y.scriptUrl =
			(Xe = C == null ? void 0 : C.src) !== null && Xe !== void 0
				? Xe
				: "undefined"),
		C != null &&
			C.params &&
			...
			C.params.forEach(function (e, r) {
				M(["onload", "compat", "_cb", "_upgrade", "_reload", "render"], r) ||
					b(
		...
		Lt && !ve
			...
			: (Lt &&
					...
					Ot(y),
					(C == null || (Ye = C.params) === null || Ye === void 0
						? void 0
						: Ye.get("render")) !== "explicit" && setTimeout(Mt, 0)),
			  (window.turnstile = Ft),
			  ve ||
					((C == null || (Ke = C.params) === null || Ke === void 0
						? void 0
						: Ke.get("render")) !== "explicit" && Ut.push(Mt),
					document.readyState === "complete" ||
					document.readyState === "interactive"
						? setTimeout(_r, 0)
						: window.addEventListener("DOMContentLoaded", _r))),
		(xr = 24 * 60 * 60 * 1e3),
